...
let wizard = new Wizard('Gandalf', 2000, 'Flaming Sword!');
wizard.castSpell();
...
class Phone {
  ...
  changePrice(newPrice) {
    // use this to change the price in case a phone isn't selling. should take in one argument, 'newPrice'. 
...
let phone1 = new Phone('Apple', 'iPhone', 128, 'blue', 1200);
let phone2 = new Phone('Samsung', 'Galaxy 45', 256, 'black', 1300);
let phone3 = new Phone('Apple', 'iPhone', 64, 'black', 800);
